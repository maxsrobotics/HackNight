...
schematic_file_path = "hacknight_demo/hacknight_demo.kicad_sch"
...
search = str(get_component_value(schematic_file_path, component_ref)) + str(sys.argv[2])
...
set_component_value(schematic_file_path, component_ref, str({outputDict[next(iter(outputDict))]['part_num']}))
print("Done!")